...
PLAYER_LASER = pygame.image.load(os.path.join("assets", "pixel_laser_player.png"))
...
def main():
    ...
    pygame.mixer.music.load("assets/sounds/background1.mp3")  # by freeplaymusic.com
...
def main_menu():
    # TODO: score mentése txt-be scoretable-höz, askstring-el név?? invadernél ugyanez!!
    title_font = pygame.font.SysFont("comicsans", 70)
    run = True
    while run:
        WIN.blit(BG, (0, 0))
        title_label = title_font.render("Click to begin...", True, (255, 255, 255))
